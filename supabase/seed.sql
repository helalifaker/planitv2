...
-- =================================================================
INSERT INTO academic_years (code, label, academic_start, academic_end, fiscal_start, fiscal_end, is_current) VALUES
('2025-2026', 'Année Scolaire 2025-2026', '2025-09-01', '2026-06-30', '2025-01-01', '2025-12-31', TRUE),
('2024-2025', 'Année Scolaire 2024-2025', '2024-09-01', '2025-06-30', '2024-01-01', '2024-12-31', FALSE);

-- =================================================================
-- SAMPLE SCHOOL (for development)
-- =================================================================
INSERT INTO schools (code, name, name_ar, aefe_status, aefe_code, country_code, city) VALUES
('EFIR', 'École Française Internationale de Riyad', 'المدرسة الفرنسية الدولية بالرياض', 'CONVENTIONNÉ', 'EFIR001', 'SA', 'Riyadh');
